...
export const SearchMarsImage = props => {
    ...
    return (
        <SafeAreaView style={[stylesSearchImage.flexBetween, stylesSearchImage.height100, stylesSearchImage.container]}>
            <ImageBackground source={{uri: BG_IMG_MARS_URI}} resizeMode="cover"
                             style={[stylesSearchImage.flexBetween, stylesSearchImage.height100, stylesSearchImage.container, stylesSearchImage.image]}>
